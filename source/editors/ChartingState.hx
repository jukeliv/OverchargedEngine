...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var gfDropDown = new FlxUIDropDownMenu(140, 240, FlxUIDropDownMenu.makeStrIdLabelArray(gfShit, true), function(gf:String)
		{
		...
		var stageDropDown = new FlxUIDropDownMenu(10, 240, FlxUIDropDownMenu.makeStrIdLabelArray(stages, true), function(stage:String)
		{
		...
		FlxG.camera.follow(strumLine,FlxCameraFollowStyle.TOPDOWN);
	}
	...
	function addNoteUI():Void
	{
		...
		var noteTypes:Array<String> = CoolUtil.coolTextFile(Paths.txt('noteTypes'));

		typeDropDown = new FlxUIDropDownMenu(10, 100, FlxUIDropDownMenu.makeStrIdLabelArray(noteTypes, true), function(type:String){
			noteType = Std.parseInt(type);
		});

		typeDropDown.selectedLabel = noteTypes[noteType];
