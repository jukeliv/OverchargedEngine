...
- mod.json:
	- This are like the `modChart.lua` from kade engine but this ones are in `JSON`. If a lot of peapole tell us than they want to use `lua` instead, we will changeit 
