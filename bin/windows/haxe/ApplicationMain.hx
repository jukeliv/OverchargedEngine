...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Overcharged", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Overcharged", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "3";
		app.meta["company"] = "overcharged dev";
		app.meta["file"] = "Overcharged";
		app.meta["name"] = "Friday Night Funkin' : Overcharged Engine";
		app.meta["packageName"] = "com.overchargeddev.overcharged";
		app.meta["version"] = "0.0.1 a";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin' : Overcharged Engine",
			width: 1280,
			x: null,
			y: null,
		};
