...
HX_DEFINE_STACK_FRAME(_hx_pos_bfb78df8014a2c60_545_new,"polymod.PolymodError","new",0xa579457c,"polymod.PolymodError.new","polymod/Polymod.hx",545,0xd80c6d61)
namespace polymod{

void PolymodError_obj::__construct( ::polymod::PolymodErrorType severity,::String code,::String message,::String origin){
            	HX_STACKFRAME(&_hx_pos_bfb78df8014a2c60_545_new)
HXLINE( 546)		this->severity = severity;
HXLINE( 547)		this->code = code;
HXLINE( 548)		this->message = message;
HXLINE( 549)		this->origin = origin;
            	}
