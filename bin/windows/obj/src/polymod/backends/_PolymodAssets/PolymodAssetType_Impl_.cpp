...
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_183_fromString,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","fromString",0xa9047b18,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.fromString","polymod/backends/PolymodAssets.hx",183,0xd8b6783c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_178_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",178,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_179_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",179,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_180_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",180,0xd8b6783c)
namespace polymod{
namespace backends{
...
::String PolymodAssetType_Impl__obj::fromString(::String str){
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_183_fromString)
HXLINE( 184)		str = str.toUpperCase();
HXLINE( 185)		::String _hx_switch_0 = str;
...
HXLINE( 187)			return str;
HXDLIN( 187)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE( 188)			return HX_("UNKNOWN",6a,f7,4e,61);
            		}
            		_hx_goto_0:;
...
HXDLIN( 170)		BYTES = HX_("BYTES",4b,40,86,3b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_171_boot)
HXDLIN( 171)		TEXT = HX_("TEXT",ad,94,ba,37);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_172_boot)
HXDLIN( 172)		IMAGE = HX_("IMAGE",3b,57,57,3b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_173_boot)
HXDLIN( 173)		VIDEO = HX_("VIDEO",5b,4c,ea,b4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_174_boot)
HXDLIN( 174)		FONT = HX_("FONT",cf,25,81,2e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_175_boot)
HXDLIN( 175)		AUDIO_GENERIC = HX_("AUDIO_GENERIC",2e,f6,26,23);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_176_boot)
HXDLIN( 176)		AUDIO_MUSIC = HX_("AUDIO_MUSIC",fc,6c,05,48);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_177_boot)
HXDLIN( 177)		AUDIO_SOUND = HX_("AUDIO_SOUND",26,29,77,b8);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_178_boot)
HXDLIN( 178)		MANIFEST = HX_("MANIFEST",af,8b,af,29);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_179_boot)
HXDLIN( 179)		TEMPLATE = HX_("TEMPLATE",3a,78,cd,05);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_180_boot)
HXDLIN( 180)		UNKNOWN = HX_("UNKNOWN",6a,f7,4e,61);
            	}
}
