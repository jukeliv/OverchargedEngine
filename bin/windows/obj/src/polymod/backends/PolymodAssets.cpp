...
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_135_exists,"polymod.backends.PolymodAssets","exists",0x9c209928,"polymod.backends.PolymodAssets.exists","polymod/backends/PolymodAssets.hx",135,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_136_getBytes,"polymod.backends.PolymodAssets","getBytes",0xe73dfe41,"polymod.backends.PolymodAssets.getBytes","polymod/backends/PolymodAssets.hx",136,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_137_getText,"polymod.backends.PolymodAssets","getText",0xfba7e397,"polymod.backends.PolymodAssets.getText","polymod/backends/PolymodAssets.hx",137,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_138_getPath,"polymod.backends.PolymodAssets","getPath",0xf8fffc8f,"polymod.backends.PolymodAssets.getPath","polymod/backends/PolymodAssets.hx",138,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_140_list,"polymod.backends.PolymodAssets","list",0x3565ecaa,"polymod.backends.PolymodAssets.list","polymod/backends/PolymodAssets.hx",140,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_155_autoDetectFramework,"polymod.backends.PolymodAssets","autoDetectFramework",0x6c71ec20,"polymod.backends.PolymodAssets.autoDetectFramework","polymod/backends/PolymodAssets.hx",155,0xd8b6783c)
namespace polymod{
namespace backends{
...
HXLINE( 127)		if (::polymod::backends::IBackend_obj::init(backend, ::Dynamic(params->__Field(HX_("frameworkParams",64,76,eb,26),::hx::paccDynamic)))) {
...
bool PolymodAssets_obj::exists(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_135_exists)
HXDLIN( 135)		return ::polymod::backends::PolymodAssets_obj::library->exists(id);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(PolymodAssets_obj,exists,return )
 ...
 ::haxe::io::Bytes PolymodAssets_obj::getBytes(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_136_getBytes)
HXDLIN( 136)		return ::polymod::backends::PolymodAssets_obj::library->getBytes(id);
            	}
...
::String PolymodAssets_obj::getText(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_137_getText)
HXDLIN( 137)		return ::polymod::backends::PolymodAssets_obj::library->getText(id);
            	}
...
::String PolymodAssets_obj::getPath(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_138_getPath)
HXDLIN( 138)		return ::polymod::backends::PolymodAssets_obj::library->getPath(id);
            	}
...
::Array< ::String > PolymodAssets_obj::list(::String type){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_140_list)
HXDLIN( 140)		return ::polymod::backends::PolymodAssets_obj::library->list(type);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(PolymodAssets_obj,list,return )
 ...
 ::polymod::Framework PolymodAssets_obj::autoDetectFramework(){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_155_autoDetectFramework)
HXDLIN( 155)		return ::polymod::Framework_obj::OPENFL_dyn();
            	}
