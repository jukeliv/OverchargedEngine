...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Overcharged",7c,24,1d,e8),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("overcharged dev",51,18,16,42));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Overcharged",7c,24,1d,e8));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin' : Overcharged Engine",bf,d2,42,1e));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.overchargeddev.overcharged",74,ac,60,67));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.0.1 a",b6,d0,39,f2));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin' : Overcharged Engine",bf,d2,42,1e))
